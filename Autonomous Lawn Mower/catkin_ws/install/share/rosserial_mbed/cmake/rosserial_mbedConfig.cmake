...
if("FALSE" STREQUAL "TRUE")
  set(rosserial_mbed_SOURCE_PREFIX /home/alex/catkin_ws/src/rosserial/rosserial_mbed)
  set(rosserial_mbed_DEVEL_PREFIX /home/alex/catkin_ws/devel)
  ...
  set(rosserial_mbed_INSTALL_PREFIX /home/alex/catkin_ws/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosserial_mbed' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/alex/catkin_ws/install/${idir}'.  ${_report}")
    endif()
