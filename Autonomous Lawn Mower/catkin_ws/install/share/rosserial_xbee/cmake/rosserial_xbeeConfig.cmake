...
if("FALSE" STREQUAL "TRUE")
  set(rosserial_xbee_SOURCE_PREFIX /home/alex/catkin_ws/src/rosserial/rosserial_xbee)
  set(rosserial_xbee_DEVEL_PREFIX /home/alex/catkin_ws/devel)
  ...
  set(rosserial_xbee_INSTALL_PREFIX /home/alex/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosserial_xbee' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/alex/catkin_ws/install/${idir}'.  ${_report}")
    endif()
