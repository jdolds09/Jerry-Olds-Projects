...
if("FALSE" STREQUAL "TRUE")
  set(ps3joy_SOURCE_PREFIX /home/alex/catkin_ws/src/joystick_drivers/ps3joy)
  set(ps3joy_DEVEL_PREFIX /home/alex/catkin_ws/devel)
  set(ps3joy_INSTALL_PREFIX "")
  set(ps3joy_PREFIX ${ps3joy_DEVEL_PREFIX})
else()
  set(ps3joy_SOURCE_PREFIX "")
  set(ps3joy_DEVEL_PREFIX "")
  set(ps3joy_INSTALL_PREFIX /home/alex/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ps3joy' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/alex/catkin_ws/install/${idir}'.  ${_report}")
    endif()
