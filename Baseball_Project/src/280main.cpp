...
// Create file variable and open input file for reading
    ifstream inFile; 
    inFile.open("/home/student/Desktop/Baseball_Project/input/280stats.txt"); 
...
// Read data from input file
    ...
    // Read in data to player variables
		...
		// Count how many games played and how many times the player got 0 hits with atleast 1 official at-bat
		    while(valid2)
		    {
		        inFile >> hits;
		        if(hits == '|')
