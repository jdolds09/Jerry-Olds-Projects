...
const char * ::TSN::responseTypeSupport::metaDescriptor[] = {"<MetaData version=\"1.0.0\"><Module name=\"TSN\"><TypeDef name=\"serial_number\"><ULong/></TypeDef><Struct name=\"post_data\">",
...
const ::DDS::ULong (::TSN::responseTypeSupport::metaDescriptorArrLength) = 6;
