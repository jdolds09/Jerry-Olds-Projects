...
<html>
	<head>
		...
		<title>Animal Shelter | Create admin</title>
...
// TODO(optional): Add some sort of input validation if we have the time
	...
	// Insert new profile in to database
		$sql = "INSERT INTO admin (First_Name, Last_Name, Username, Pwd, Mobile_Number, Email) 
				VALUES  ('$first_name', '$last_name', '$username', '$pwd', '$phone_number', '$email')";
